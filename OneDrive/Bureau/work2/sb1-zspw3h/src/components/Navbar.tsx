      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to={"/about"} className="text-stone-600 hover:text-amber-700 transition-colors">About Us</Link>
            <Link to={"/venues"} className="text-stone-600 hover:text-amber-700 transition-colors">Venues</Link>
            <Link to={"/teamsection"} className="text-stone-600 hover:text-amber-700 transition-colors">Our Team</Link>
